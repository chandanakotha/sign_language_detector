...
previous_signs = []
last_sign = None  # Variable to track the last recognized sign
...
while True:
    ...
    # Add the sign to the previous signs list only if it's a new and different sign
    if sign is not None and sign != last_sign:
        previous_signs.append(sign)
        last_sign = sign  # Update the last sign to the current one
